...
const GUIDE_OPTIONS: GuideOption[] = [
  ...
  { label: 'I feel rushed', topicId: 'feel-rushed', categoryId: 'timing', color: '#e11d48' },
  { label: 'I struggle with velocity', topicId: 'struggle-with-velocity', categoryId: 'timing', color: '#e11d48' },
  ...
  { label: 'I can\'t go opposite field', topicId: 'pulling-off', categoryId: 'posture', color: '#0891b2' },
  ...
  { label: 'I chase too much', topicId: 'chasing', categoryId: 'adjustability', color: '#f59e0b' },
  { label: 'I don\'t hit the ball hard', topicId: 'weak-contact', categoryId: 'contact', color: '#3b82f6' },
  { label: 'I feel off balance', topicId: 'pulling-off', categoryId: 'posture', color: '#0891b2' },
  { label: 'I feel disconnected / armsy', topicId: 'disconnected', categoryId: 'contact', color: '#3b82f6' },
  ...
  { label: 'My swing feels slow', topicId: 'no-bat-speed', categoryId: 'contact', color: '#3b82f6' },
  { label: 'I have no power', topicId: 'no-power', categoryId: 'contact', color: '#3b82f6' },
