...
const ITEM_PRIORITY: Record<RequiredTodayItemKey, Omit<NextPriority, 'action'>> = {
  ...
  habits: {
    title: 'Habit Tracker',
    subtitle: 'Log your daily non-negotiables',
  ...
  addons: {
    ...
    subtitle: 'Use your purchased add-on content',
...
const STATIC: Record<string, Omit<NextPriority, 'action'>> = {
  complete_assessment: {
    ...
    route: '/(app)/training/sc/sc-profile-setup',
    icon: 'clipboard-outline',
    color: '#f59e0b',
  },
  log_metrics: {
    title: 'Log Performance Metrics',
    subtitle: 'Retest due — log key metrics to track development',
    route: '/(app)/training/metrics-log',
