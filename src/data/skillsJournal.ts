...
export const MENTAL_SKILLS: MentalSkill[] = [
  {
    ...
    courseId: 'awareness',
    courseRoute: '/(app)/training/mental/awareness-course',
  ...
  },
  {
    ...
    courseId: 'confidence',
    courseRoute: '/(app)/training/mental/confidence-course',
  ...
  },
  {
    ...
    courseId: 'focus',
    courseRoute: '/(app)/training/mental/focus-course',
    courseLabel: 'Focus',
    courseColor: '#3b82f6',
  },
  {
    ...
    courseRoute: '/(app)/training/mental/emotional-control-course',
  ...
  },
  {
    ...
    courseId: 'resilience',
    courseRoute: '/(app)/training/mental/resilience-course',
  ...
  },
  {
    ...
    courseRoute: '/(app)/training/mental/accountability-course',
